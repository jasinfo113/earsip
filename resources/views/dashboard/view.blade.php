    ...
    <form id="form_pegawai" data="pegawai" method="post" autocomplete="off" onsubmit="return false">
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="table_data" data="pegawai"
                            ...
                            <thead>
                                <tr class="text-start fw-bolder fs-7 gs-0">
                                    ...
                                    <th class="text-start">NRK/ID.PJLP</th>
                                    <th class="text-start">Nama</th>
                                    <th class="text-start">Jenis.Pegawai</th>
                                    <th class="text-start">Unit.Kerja</th>
                                    <th class="text-start">Sub.Unit.Kerja</th>
