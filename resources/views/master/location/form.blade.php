                ...
                <div class="d-flex flex-column m-3">
                    <div class="field-user ">
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2" id="input_name">Lokasi</label>
                            <input type="text" class="form-control form-control-solid mb-3 mb-lg-0" name="location"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#form_data").submit(function(e) {
            e.preventDefault();
            submitData(this, "master/location/save", showData, true, true);
        });
