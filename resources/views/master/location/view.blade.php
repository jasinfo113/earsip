<x-app-layout>
    <form id="form_query" data="categori" method="post" autocomplete="off" onsubmit="return false">
        <div class="card card-xl-stretch mb-xl-8">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <div class="d-flex gap-2 justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-danger" onclick="delTable('master/location/del', showData)" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" title="Hapus data">
                            <i class="fa fa-trash p-0"></i>
                        </a>
                        @endif
                        @if (config('app.user_access.create', 0) == 1)
                        <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-primary" onclick="openForm('master/location/form')" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" title="Tambah data">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="table_data" class="datalocation display mobile-responsive table table-rounded table-row-bordered border border-gray-200 table-row-gray-200 g-2">
                            <thead>
    ...
    <script src="{{ asset('assets/scripts/master/location.js?v=' . time()) }}"></script>
</x-app-layout>
