<x-app-layout>
            ...
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <div class="d-flex gap-2 justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="javascript:void(0)" class="btn btn-sm btn-icon btn-danger" onclick="delTable('manage/user/del', showData)" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" title="Hapus data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-solid select2-multiple select-status" name="status_ids[]" id="filter_status" data-control="select2" data-allow-clear="true" data-close-on-select="false" data-placeholder="Select an option" onchange="showData()" multiple="multiple">
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
    ...
    <script src="{{ asset('assets/scripts/manage/user.js?v=' . time()) }}"></script>
</x-app-layout>
