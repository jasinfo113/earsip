    ...
    <div class="modal-dialog modal-dialog-centered mw-950px">
        <div class="modal-content">
            ...
            <div class="modal-body m-4" id="pdf-container">
                ...
                <div id="qr-code-wrapper" data-code="<?php echo e($code); ?>" data-x="10" data-y="10"
                    style="position: absolute; top: 10px; left: 10px; width: 100px; height: 100px; background: transparent;">
                </div>
                <input type="hidden" name="update" id="namafile" value="<?php echo e($nama_file); ?>" />
                <input type="hidden" name="id" value="<?php echo e($code); ?>" />
                <input type="hidden" name="document_id" value="<?php echo e($document_id); ?>" />
...
<link rel="stylesheet" href="<?php echo e(asset('assets/styles/pembubuhan/jquery-ui.css?v=' . time())); ?>" type="text/css" />
<script src="<?php echo e(asset('assets/scripts/pembubuhan/jquery-ui.min.js?v=' . time())); ?>"></script>
<script src="<?php echo e(asset('assets/scripts/pembubuhan/pdf.min.js?v=' . time())); ?>"></script>
<script src="<?php echo e(asset('assets/scripts/pembubuhan/jspdf.umd.min.js?v=' . time())); ?>"></script>
<script src="<?php echo e(asset('assets/scripts/pembubuhan/qrcode.min.js?v=' . time())); ?>"></script>
...
<script>
    pdfjsLib.GlobalWorkerOptions.workerSrc = "<?php echo e(asset('assets/scripts/pembubuhan/pdf.worker.min.js')); ?>";

    function loadPDF() {
        const pdfUrl = "<?php echo e($nama_file); ?>"; // URL file PDF
    ...
    function generateQRCode() {
        ...
        const code = wrapper.data('code') || "<?php echo e($code); ?>";
        wrapper.html('');
...
corners.forEach(pos => {
    ...
    function savePDF() {
        ...
        formData.append('id', '<?php echo e($code); ?>');
        formData.append('document_id', '<?php echo e($document_id); ?>');

        $.ajax({
            url: '<?php echo e(route('savePdfToServer')); ?>',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<?php /**PATH C:\laragon\www\pekerjaan\damkar\earsip\resources\views/main/archives/pembubuhan.blade.php ENDPATH**/ ?>