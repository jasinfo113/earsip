...
<?php $component->withAttributes([]); ?>
    <div class="d-flex flex-column flex-xl-row">
                ...
                <div class="card-body">
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <a href="javascript:void(0)"
                            class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3"><?php echo e(Auth::user()->name); ?></a>
                        <div class="mb-9">
                            <div class="badge badge-lg badge-light-primary d-inline"><?php echo e(Auth::user()->role); ?></div>
                        </div>
                    </div>
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            ...
                            <div class="text-gray-600"><?php echo e(Auth::user()->username); ?></div>
                            <div class="fw-bolder mt-5">Email</div>
                            <div class="text-gray-600">
                                <a href="javascript:void(0)"
                                    class="text-gray-600 text-hover-primary"><?php echo e(Auth::user()->email); ?></a>
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            <form id="form_profile" class="m-form m-form--label-align-left- m-form--state-" method="post"
                ...
                <?php echo csrf_field(); ?>
                <input type="file" name="photo" class="userfile d-none" default="<?php echo e(Auth::user()->photo); ?>"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" class="form-control form-control-lg form-control-solid"
                                    name="name" id="input_name" placeholder="Name" value="<?php echo e(Auth::user()->name); ?>"
                                    required />
                            </div>
                        </div>
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text"
                                    ...
                                    placeholder="Username" value="<?php echo e(Auth::user()->username); ?>" required />
                            </div>
                        </div>
                        <div class="row mb-6">
    ...
    <script src="<?php echo e(asset('assets/scripts/account/profile.js?v=' . time())); ?>"></script>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\pekerjaan\damkar\earsip\resources\views/account/view.blade.php ENDPATH**/ ?>