    ...
    <td class="left" colspan="3">
        <div style="display: flex; gap: 40px; align-items: center;">
            <div style="text-align: center;">
                <a href="<?php echo e(asset('uploads/main/arsip/' . $row->file)); ?>" target="_blank">
                    <i class="fa fa-file-pdf fa-4x text-danger"></i><br>
                    <span>File Asli</span>
                </a>
            </div>
            <div style="text-align: center;">
                <a href="<?php echo e(asset('uploads/main/arsip/' . $row->hasil_pdf)); ?>" target="_blank">
                    ...
                    <tr>
                        ...
                        <td> : </td>
                        <th class="left">
                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo e($uk->name); ?><?php echo e(!$loop->last ? ', ' : ''); ?>
...
<?php /**PATH C:\laragon\www\pekerjaan\damkar\earsip\resources\views/main/archives/detail.blade.php ENDPATH**/ ?>