...
class EsatgasAparNew extends Model
{

    public $timestamps = false;

    protected $connection = 'esatgas';
    protected $table = 'sarop_apar_new';
    ...
    public function scopeApi(Builder $query, $user)
    {
        ...
        $query->selectRaw("sarop_apar_new.*");
        $query->selectRaw("DATE_FORMAT(sarop_apar_new.tgl_lahir, '%d %M %Y') AS birthdate");
