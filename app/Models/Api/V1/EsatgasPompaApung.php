...
class EsatgasPompaApung extends Model
{

    public $timestamps = false;

    protected $connection = 'esatgas';
    protected $table = 'sarop_pompa_apung';
    protected $primaryKey = 'id_pompa_apung';
    ...
    protected $fillable = [
        ...
        'pompa_rusak',
        'pompa_keterangan',
        'selang_satu_lima_baik',
        'selang_satu_lima_rusak',
        'selang_satu_lima_keterangan',
        'selang_dua_lima_baik',
        'selang_dua_lima_rusak',
        'selang_dua_lima_keterangan',
        ...
        'saringan_hisap_baik',
        'saringan_hisap_rusak',
        'saringan_hisap_keterangan',
        'accu_baik',
        'accu_rusak',
        'accu_keterangan',
        'kopling_adaptor_baik',
        'kopling_adaptor_rusak',
        'kopling_adaptor_keterangan',
        'no_kota',
        'nama_kota',
        'no_kecamatan',
        'nama_kecamatan',
    ...
    {
        $path = config('filesystems.assets.esatgas') . "sarana_operasi/pompa_apung/";
        $query->selectRaw("id_pompa_apung AS id,kd_pompa_apung AS `code`");
        $query->selectRaw("CONCAT('" . $path . "', tautan_foto) AS image");
        $query->selectRaw("sarop_pompa_apung.*");
    ...
    public function getInfosAttribute()
    {
        ...
        $attributes[] =
            [
                "type" => "value",
                "name" => "Selang 1.5",
                "baik" => (int)$this->selang_satu_lima_baik,
                "rusak" => (int)$this->selang_satu_lima_rusak,
                "note" => (string)_strip($this->selang_satu_lima_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "Selang 2.5",
                "baik" => (int)$this->selang_dua_lima_baik,
                "rusak" => (int)$this->selang_dua_lima_rusak,
                "note" => (string)_strip($this->selang_dua_lima_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
        ...
        $attributes[] =
            [
                "type" => "value",
                "name" => "Saringan Hisap",
                "baik" => (int)$this->saringan_hisap_baik,
                "rusak" => (int)$this->saringan_hisap_rusak,
                "note" => (string)_strip($this->saringan_hisap_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "Kopling Adaptor",
                "baik" => (int)$this->kopling_adaptor_baik,
                "rusak" => (int)$this->kopling_adaptor_rusak,
                "note" => (string)_strip($this->kopling_adaptor_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "ACCU",
                "baik" => (int)$this->accu_baik,
                "rusak" => (int)$this->accu_rusak,
