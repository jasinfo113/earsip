...
class EsatgasHydrantKering extends Model
{

    public $timestamps = false;

    protected $connection = 'esatgas';
    protected $table = 'sarop_hydrant_kering';
    protected $primaryKey = 'id_hydrant_kering';
    ...
    protected $fillable = [
        ...
        'box_hydrant_baik',
        'box_hydrant_rusak',
        'box_hydrant_keterangan',
        'kondisi_box_hydrant',
        'kondisi_box_hydrant_keterangan',
        'kondisi_cat',
        'cat_box_hydrant_keterangan',
        'selang_baik',
        'selang_rusak',
        'selang_keterangan',
        'nozzle_baik',
        'nozzle_rusak',
        'nozzle_keterangan',
        'kunci_box_hydrant_baik',
        'kunci_box_hydrant_rusak',
        'kunci_box_hydrant_keterangan',
        'landing_valve_baik',
        'landing_valve_rusak',
        'landing_valve_keterangan',
        'hydrant_pilar_baik',
        'hydrant_pilar_rusak',
        'hydrant_pilar_keterangan',
        'siamese_conection_baik',
        'siamese_conection_rusak',
        'siamese_conection_keterangan',
        'rambu_hydrant_baik',
        'rambu_hydrant_rusak',
        'rambu_hydrant_keterangan',
        'no_kota',
        'nama_kota',
        'no_kecamatan',
        'nama_kecamatan',
    ...
    {
        $path = config('filesystems.assets.esatgas') . "sarana_operasi/hydrant_kering/";
        $query->selectRaw("id_hydrant_kering AS id,kd_hydrant_kering AS `code`");
        $query->selectRaw("CONCAT('" . $path . "', tautan_foto) AS image");
        $query->selectRaw("sarop_hydrant_kering.*");
    ...
    public function getInfosAttribute()
    {
        $attributes[] =
            [
                "type" => "value",
                "name" => "Box",
                "baik" => (int)$this->box_hydrant_baik,
                "rusak" => (int)$this->box_hydrant_rusak,
                "note" => (string)_strip($this->box_hydrant_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "Kunci Box",
                "baik" => (int)$this->kunci_box_hydrant_baik,
                "rusak" => (int)$this->kunci_box_hydrant_rusak,
                "note" => (string)_strip($this->kunci_box_hydrant_keterangan),
            ];
        $attributes[] =
            [
                "type" => "condition",
                ...
                "condition" =>
                [
                    "name" => (string)strtoupper($this->kondisi_box_hydrant),
                    "label" => (string)($this->kondisi_box_hydrant == "baik" ? "success" : "danger"),
                ],
                "note" => (string)_strip($this->kondisi_box_hydrant_keterangan),
            ];
        $attributes[] =
            [
                "type" => "condition",
                ...
                "condition" =>
                [
                    "name" => (string)strtoupper($this->kondisi_cat),
                    "label" => (string)($this->kondisi_cat == "bagus" ? "success" : "danger"),
                ],
                "note" => (string)_strip($this->cat_box_hydrant_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
        ...
        $attributes[] =
            [
                "type" => "value",
                "name" => "Landing Valve",
                "baik" => (int)$this->landing_valve_baik,
                "rusak" => (int)$this->landing_valve_rusak,
                "note" => (string)_strip($this->landing_valve_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "Pilar",
                "baik" => (int)$this->hydrant_pilar_baik,
                "rusak" => (int)$this->hydrant_pilar_rusak,
                "note" => (string)_strip($this->hydrant_pilar_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "Siamese Connection",
                "baik" => (int)$this->siamese_conection_baik,
                "rusak" => (int)$this->siamese_conection_rusak,
                "note" => (string)_strip($this->siamese_conection_keterangan),
            ];
        $attributes[] =
            [
                "type" => "value",
                "name" => "Rambu",
                "baik" => (int)$this->rambu_hydrant_baik,
                "rusak" => (int)$this->rambu_hydrant_rusak,
                "note" => (string)_strip($this->rambu_hydrant_keterangan),
            ];
        return $attributes;
    }
